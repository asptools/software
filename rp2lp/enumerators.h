...
// same as subset enumerator, but enumerates set in the
// reverse order, i.e., starting with the set of all n
// elements and working down towards the empty set
class ReverseSubsetEnumerator : public SubsetEnumerator {
 public:
  ReverseSubsetEnumerator(index_type _n) : SubsetEnumerator(_n) { };
  virtual ~ReverseSubsetEnumerator() { };
...
class mSubsetEnumerator : public SubsetEnumerator {
 ...
 public:
  ...
  static count_type m_of_n(index_type n, index_type m);
  count_type n_sets();
