...
class SaveToFile : public Plan {
  Plan* printer;
  std::ofstream planfile;

 public:
  SaveToFile(Instance& i, Stopwatch* s, const std::string& name);
  virtual ~SaveToFile();
...
class SaveAllToFile : public PlanSet {
  Instance&  instance;
  Stopwatch* stats;
  std::string basename;
  count_type next;
 ...
 public:
  SaveAllToFile(Instance& i, Stopwatch* s, const std::string& b);
  virtual ~SaveAllToFile();
...
class Store : public Result, public ScheduleSet {
 ...
 public:
  ...
  virtual void solution(State& s, Transition* t, NTYPE cost);
  virtual void solution(State& s, NTYPE cost);
