...
bool TemporalRegState::shortcut_solved = false;
    ...
    final(false)
{
  ...
  // }
  // else {
  //   extended_cost c = heuristic.extended_eval(set);
  //   if (c.second && shortcut_solved) {
  //     delta = c.first;
  //     final = true;
  //   }
  //   else {
...
Transition* TemporalRegState::transition()
{
  return new ParaRegTrans(starts, noops, delta);
}
