...
index_type ParaRSRegState::hash()
{
  index_type v1 = AtomSetState::hash();
  index_type v2 = instance.atom_set_hash(noops);
  index_type v3 = instance.action_set_hash(acts);
  return (v1 + v2) ^ v3;
}
